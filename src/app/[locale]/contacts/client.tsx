  ...
  <section className="relative w-full flex flex-1 flex-col pt-5">
    <header className="h-12">
      <h2 className="text-[0.9375rem] font-semibold">
        {clientT.value?.Contacts.form.title}
      </h2>
    </header>
    <Form
      onSubmit={({
        ...
        if (err) {
          toast.error(clientT.value?.Contacts.form.error_message);
          return;
        }

        toast.success(clientT.value?.Contacts.form.success_message);
      }}
    >
      {({ isValid, submit }) => (
        <form
        ...
        >
          <Field
            ...
            onBlurValidate={z
              ...
              .min(
                1,
                clientT.value?.Contacts.form.validation_errors.min_length,
              )}
          >
            {({ value, setValue, onBlur, errors }) => (
              <>
                <div className="flex flex-col rounded-lg bg-[#5E5E75E3] px-4 py-1.5">
                  ...
                  >
                    {clientT.value?.Contacts.form.fields_labels.name}
                  </label>
                  <input
                    id="name"
                    value={value}
              ...
              <>
                <div className="flex flex-col rounded-lg bg-[#5E5E75E3] px-4 py-1.5">
                  <label
                    ...
                    className="text-[0.625rem] font-medium text-[#DADADA]"
                  >
                    {clientT.value?.Contacts.form.fields_labels.phone_number}
                  </label>
                  <input
                    id="phone-number"
                    value={value}
          ...
          <Field
            ...
            onBlurValidate={z
              .string()
              .email(clientT.value?.Contacts.form.validation_errors.email)}
          >
            {({ value, setValue, onBlur, errors }) => (
              <>
                <div className="flex flex-col rounded-lg bg-[#5E5E75E3] px-4 py-1.5">
                  <label
                    ...
                    className="text-[0.625rem] font-medium text-[#DADADA]"
                  >
                    {clientT.value?.Contacts.form.fields_labels.email}
                  </label>
                  <input
                    id="email"
                    value={value}
              ...
              <>
                <div className="flex flex-col rounded-lg bg-[#5E5E75E3] px-4 py-1.5">
                  <label
                    ...
                    className="text-[0.625rem] font-medium text-[#DADADA]"
                  >
                    {clientT.value?.Contacts.form.fields_labels.company_name}
                  </label>
                  <input
                    id="company-name"
                    value={value}
              ...
              <>
                <div className="flex flex-col rounded-lg bg-[#5E5E75E3] px-4 py-1.5">
                  <label
                    ...
                    className="text-[0.625rem] font-medium text-[#DADADA]"
                  >
                    {clientT.value?.Contacts.form.fields_labels.website}
                  </label>
                  <input
                    id="website"
                    value={value}
              ...
              <>
                <div className="flex flex-col rounded-lg bg-[#5E5E75E3] px-4 py-1.5">
                  <label
                    ...
                    className="text-[0.625rem] font-medium text-[#DADADA]"
                  >
                    {clientT.value?.Contacts.form.fields_labels.message}
                  </label>
                  <textarea
                    id="message"
                    value={value}
          ...
          >
            {clientT.value?.Contacts.form.action}
          </button>
        </form>
      )}
    </Form>
